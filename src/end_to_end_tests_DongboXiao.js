/*
 Created by Dongbo Xiao on 3/23/14
 */
 ...
 * Bugs found:
 * 1.
 * When the pause click to add force, or attack
 * if it clicked on the green or red mark,
 * it would not add the force.
 * Think it may be count as a bug.
 *
 * 2.
 * The you clicked notation sometimes is out of the screen
 * so I cant see which has been clicked.
 *
 */
...
describe('Risk', function () {
    ...
    it('should show a red piece if I click in India', function () {
        board = getInitialBoard(2);
        clickAreaAndExpectPiece("India", 0);
        board.territory.India.owner = 0;
        board.territory.India.units = 1;
        expectBoard(board);
    });

    it('should show a red piece if I click in China', function () {
        board = getInitialBoard(2);
    ...
    it('should pass Russia to green when clicked 2nd', function () {
        board = getInitialBoard(2);
        clickAreaAndExpectPiece("China", 0);
    ...
    it('should pass china to green and Russia to red when clicked 2nd', function () {
        board = getInitialBoard(2);
        clickAreaAndExpectPiece("Russia", 0);
        clickAreaAndExpectPiece("China", 1);
        board.territory.Russia.owner = 0;
        board.territory.Russia.units = 1;
        board.territory.China.owner = 1;
        board.territory.China.units = 1;
        expectBoard(board);
    });

    it('should pass china to green and Russia to red when clicked 2nd then India to red', function () {
        board = getInitialBoard(2);
        clickAreaAndExpectPiece("Russia", 0);
        clickAreaAndExpectPiece("China", 1);
        clickAreaAndExpectPiece("India", 1);
        board.territory.Russia.owner = 0;
        board.territory.Russia.units = 1;
        board.territory.China.owner = 1;
        board.territory.China.units = 1;
    ...
    it('should pass china to green and Russia to red when clicked 2nd' +
    ' then India to red, then Indonesia to green', function () {
        board = getInitialBoard(2);
        clickAreaAndExpectPiece("Russia", 0);
        clickAreaAndExpectPiece("China", 1);
        clickAreaAndExpectPiece("India", 1);
        clickAreaAndExpectPiece("Indonesia", 1);
        board.territory.Russia.owner = 0;
        board.territory.Russia.units = 1;
        board.territory.China.owner = 1;
        board.territory.China.units = 1;
        board.territory.India.owner = 0;
        board.territory.India.units = 1;
        board.territory.Indonesia.owner = 1;
        board.territory.Indonesia.units = 1;
        expectBoard(board);
    });
    ...
    it('should ignore clicking on a non-empty country before the board is full', function () {
        board = getInitialBoard(2);
        clickAreaAndExpectPiece("Russia", 0);
        clickAreaAndExpectPiece("Russia", 0); // clicking on a non-empty cell doesn't do anything.
        board.territory.Russia.owner = 0;
        board.territory.Russia.units = 1;
        expectBoard(board);
    });
