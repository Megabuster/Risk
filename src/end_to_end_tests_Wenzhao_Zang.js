...
describe('Risk', function() {
    ...
    it('should show a red piece if I click on Japan', function () {
        board = getInitialBoard(2);
        clickAreaAndExpectPiece("Japan", 0);
        board.territory.Japan.owner = 0;
        board.territory.Japan.units = 1;
        expectBoard(board);
    });
    ...
    it('should ignore clicking on a non-empty country before the board is full', function () {
        board = getInitialBoard(2);
        clickAreaAndExpectPiece("Japan", 0);
        clickAreaAndExpectPiece("Japan", 0); // clicking on a non-empty cell doesn't do anything.
        clickAreaAndExpectPiece("Russia", 1);
        clickAreaAndExpectPiece("Russia", 1);// clicking on a non-empty cell doesn't do anything.
        board.territory.Japan.owner = 0;
        board.territory.Japan.units = 1;
